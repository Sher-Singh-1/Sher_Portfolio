...
export const projects: Project[] = [
  ...
  { id: 'vms', title: 'VMS & Video Analytics', category: 'DevOps', year: '2025 — Present', accent: 'violet', icon: satelliteIcon, summary: 'Field deployment of VMS & video analytics across government and enterprise sites — AWS, Linux, VM & physical servers.', problem: 'Government and enterprise video-surveillance rollouts need reliable field deployment across mixed AWS, on-prem VM, and physical server environments, plus fast production support.', solution: 'Deployed and supported Mirasys VMS & video analytics on AWS, Linux, virtual machines, and physical servers in the field, and deployed analytics/DIP software with cloud and physical infrastructure for enterprise sites.', contribution: 'As a DevOps Engineer at Mirasys India Pvt. Ltd. (2025 — Present), deployed and supported production VMS/VA systems at government sites — GAIL Jhabua, HPHC, Bilaspur Smart City, FSL Mumbai Surveillance, and Moradabad Smart City — and at enterprise sites like the Metso warehouse, covering analytics VMS software, DIP software, cloud infra, and physical infra.', technologies: ['AWS', 'Linux', 'VM & Physical Servers', 'DIP Software', 'REST APIs', 'Networking'], features: ['Government field deployments: GAIL Jhabua, HPHC, Bilaspur Smart City, FSL Mumbai Surveillance, Moradabad Smart City', 'Enterprise deployment: Metso warehouse analytics VMS & DIP software', 'AWS, Linux, VM & physical server infrastructure', 'Production troubleshooting & observability'] },
