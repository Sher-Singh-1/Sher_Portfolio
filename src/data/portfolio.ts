...
export type Project = {
  ...
  problem: string; solution: string; contribution: string; technologies: string[]; features: string[]; accent: string; icon: string; link?: string; demo?: string; architecture?: string; video?: string;
}
...
export const projects: Project[] = [
  { id: 'go-sheros', title: 'Go Sheros', category: 'Web Apps', year: '2026', accent: 'gold2', icon: robotIcon, demo: 'https://go-sheros.vercel.app', summary: 'AI-powered goal planner and productivity coach — plan, do, track, and improve.', problem: 'Turning a big goal into a realistic, trackable plan usually takes manual effort and constant upkeep.', solution: 'A Next.js app that decomposes goals into milestones and tasks, backed by an AI coach (with a deterministic fallback) plus focus timers, habits, streaks, and analytics.', contribution: 'Built the full-stack MVP end-to-end: auth, goal-decomposition engine, AI coach integration, streak tracking, and analytics dashboard.', technologies: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Prisma', 'PostgreSQL', 'Recharts'], features: ['AI-assisted goal decomposition into milestones & tasks', 'Focus timer, habits & streak tracking', 'Email-OTP auth with JWT sessions', 'Progress analytics dashboard'] },
  { id: 'fire', title: 'Fire Detection System', category: 'AI / ML', year: '2025', accent: 'orange', icon: fireIcon, summary: 'AI-powered fire-event detection for surveillance environments with operational monitoring.', problem: 'Surveillance workflows need dependable detection and visibility into system health.', solution: 'A custom YOLO model detects fire events while Grafana and Prometheus surface operational signals.', contribution: 'Trained custom YOLO detection models and helped integrate monitoring tools into the VMS environment.', technologies: ['Python', 'YOLOv5', 'YOLOE', 'Docker', 'Grafana', 'Prometheus', 'Netdata'], features: ['Real-time fire event detection'] },
  { id: 'vms', title: 'VMS & Video Analytics', category: 'DevOps', year: '2025 — Present', accent: 'violet', icon: satelliteIcon, summary: 'Deployment and production support for government & enterprise VMS, Video Analytics, and Decision Intelligence Platform sites.', problem: 'Government and enterprise video-surveillance rollouts span AWS, on-prem VMs, and physical servers — each site needs reliable deployment, integration, and fast production support.', solution: 'Deploy and support Mirasys VMS, Video Analytics (VA), Decision Intelligence Platform (DIP), FRS, and ANPR solutions across mixed AWS, Linux, VM, and physical-server environments, contributing to integration and infrastructure monitoring on both cloud and on-prem infrastructure.', contribution: 'Deployed VMS, Video Analytics (VA), Decision Intelligence Platform (DIP), FRS, and ANPR solutions for government sites — GAIL Jhabua, HPHC, Bilaspur Smart City, FSL Mumbai Surveillance, and Moradabad Smart City — plus enterprise deployments, contributing to integration and infrastructure monitoring.', technologies: ['AWS', 'Linux', 'VM & Physical Servers', 'DIP Software', 'FRS', 'ANPR', 'REST APIs', 'Networking', 'Grafana', 'Prometheus'], features: ['Government deployments — GAIL Jhabua, HPHC, Bilaspur Smart City, FSL Mumbai Surveillance, Moradabad Smart City', 'VMS, VA, DIP, FRS & ANPR solution deployment', 'AWS, Linux, VM & physical-server infrastructure', 'Integration & infrastructure monitoring'] },
  { id: 'sheros', title: 'SHEROS', category: 'Monitoring', year: '2025', accent: 'lime', icon: barChartIcon, video: 'media/sheros-demo.webm', summary: 'Cross-platform system health monitoring with a local dashboard and SQLite-backed history.', problem: 'System health signals can be hard to track consistently across Windows and Linux machines.', solution: 'A local monitoring application that exposes health metrics through REST APIs and presents them in a responsive dashboard.', architecture: 'Python and psutil collect system data; REST APIs expose it to a responsive web dashboard; SQLite retains local historical data.', contribution: 'Built the cross-platform monitoring workflow, dashboard, local storage, threshold alerts, and environment setup automation.', technologies: ['Python', 'psutil', 'SQLite', 'REST API', 'Shell', 'Windows', 'Linux'], features: ['CPU, memory, disk, network, uptime & process monitoring', 'SQLite storage with configurable retention', 'Threshold-based alerts', 'Automated Windows & Linux setup'] },
]
