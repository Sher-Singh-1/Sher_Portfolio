...
export type Project = {
  ...
  problem: string; solution: string; contribution: string; technologies: string[]; features: string[]; accent: string; icon: string; link?: string;
}
